...
# UGREP_THREADS: Number of threads for all ugrep operations (filtering and pattern matching)
# SORT_THREADS: Number of threads for sort operations
...
fuzzy_bc_pipeline() {
    ...
    | sort --parallel=$SORT_THREADS --temporary-directory=$TMP_DIR - | uniq -c \
